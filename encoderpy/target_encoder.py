...
def target_encoder(X_train, y, cat_columns, X_test = None, prior = 0.5, objective = 'regression'):
        ...
        test_processed : pd.DataFrame 
                ...
                replaced by the learned encodings from the training set. This is an optional argument.
