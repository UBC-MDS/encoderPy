...
train_encoded1, test_encoded1 = onehot_encoder.onehot_encoder(X_train, X_test, categories1)
   
# Encode data with categories 2
train_encoded1, test_encoded1 = onehot_encoder.onehot_encoder(X_train, X_test, categories2)
...
def test_output():
    ...
    "The shape of processed test dataset is wrong: Check that your function is processing the test dataset correctly"
    ...
    assert ("treatment_B" in train_encoded1) == True, "Check your function, it should generate a treatment_B column using the test data"
