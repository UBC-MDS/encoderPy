...
In general, the Normal-Inverse-gamma distribution is parameterized such that the density is a function of two random variables x and sigma. Thus, the second column shown above, `cyl_encoded_var` is the expected value of sigma.
